...
export default function UserGuide() {
  return (
    <div className="glass-panel animate-fade-in" style={{ padding: '40px' }}>
      <h2 style={{ marginBottom: '24px' }}>📘 MedGraph AI User Guide</h2>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
          Use the "Upload Rx" page to scan handwritten prescriptions or typed lab reports. MedGraph AI will extract the medicine names and dosages using OCR. You can then confirm the details and the system will automatically schedule reminders for you.
        </p>
      </section>
