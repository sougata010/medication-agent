  ...
  return (
    <div className="glass-panel animate-fade-in" style={{ padding: '40px' }}>
      ...
      <section style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', lineHeight: '1.6' }}>
          VitaLeaf is not designed to handle medical emergencies. If you are experiencing an emergency, experiencing acute chest pain, stroke symptoms, or severe anaphylaxis, call your local emergency dispatch immediately (e.g., 911).
        </p>
      </section>
